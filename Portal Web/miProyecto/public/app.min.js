...
document.addEventListener('DOMContentLoaded', () => {
    const cancelReservationForm = document.forms['cancel-reservation-form'];

    cancelReservationForm.addEventListener('submit', async (e) => {
        e.preventDefault(); // Evita la recarga de la página

        // Captura el valor del campo "ID de Reserva"
        ...
        try {
            ...
            if (response.ok) {
                const data = await response.json();
                alert(data.message); // Muestra un mensaje de éxito al usuario
            } else {
                console.error('Error en la solicitud.');
            }
        } catch (err) {

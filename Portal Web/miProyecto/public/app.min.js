...
// Fusion DOM CONTENT
document.addEventListener('DOMContentLoaded', function() {
    // Inicializaciones y listeners aquí
...
function actualizarSelectHoras(horasDisponibles) {
    ...
    if (horasDisponibles.length === 0) {
        ...
        horasDisponibles.forEach(function(hora) {
            var option = document.createElement('option');
            option.value = hora; // Asegúrate de que esto es una cadena 'HH:MM'
            option.textContent = hora; // y esto también
            timepicker.appendChild(option);
        });
    }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(event) {
        ...
        .then(data => {
            ...
            // Aquí podrías redirigir a otra página o limpiar el formulario si así lo deseas
    ...
    // Asegúrate de que este código esté dentro de un 'DOMContentLoaded' o después de que el formulario esté definido en tu HTML
    ...
    cancelForm.addEventListener('submit', function(event) {
        ...
        .then(data => {
            ...
            cancelForm.reset(); // Opcional: limpia el formulario
        })
        .catch((error) => {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(event) {
        ...
        .then(data => {
            if (data.error) {
                // Si hay un mensaje de error, muéstralo en la alerta
                alert('Error: ' + data.error);
            } else {
                // Si la reserva fue exitosa, muestra la confirmación
